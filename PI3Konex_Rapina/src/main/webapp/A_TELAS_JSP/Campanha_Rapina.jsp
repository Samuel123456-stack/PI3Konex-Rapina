        ...
        <div id="container-landing">
            <div class="background-color">
                ...
                <div class="rapina-campaign">
                    <div class="introducing-context">
                        <div class="flying-with-rapina">
                            <p>Campanha Rapinante</p>
                            <h1>É pra quem gosta de voar junto</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="donation-page">
                <section class="grid-layout">
                    ...
                    <div>
                        <h1>Doações</h1>
                        <article class="donation-content">
                            <p>
                                Sabemos a importância da colaboração, por isso nós damos
                                a oportunidade de você fazer a diferença. Você doa algum
                                valor para instituições que você frenquentou, ou você doa
                                para à Rapina e nós distribuímos para ONG’S brasileiras.

                            </p>
                            <p>
                                Há diversos setores de ONG’S que nós distribuimos, 
                                elas  promovem incentivações esportivas, 
                                para Educação e Pesquisa, Saúde, Meio ambiente e Assistência social.
                                A sua contribuição faz diferença.
                            </p>

                            <p>#juntosvoamosmaisalto.</p>
                        </article>
                    </div>
                </section>

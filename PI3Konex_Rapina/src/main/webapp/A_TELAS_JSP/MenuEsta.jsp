    ...
    <div id="container-landingesta">
        <section class="menu-baresta">
            ...
            <div class="nomeMenuesta">
                <h1>Olá </h1><p>user</p><h1>, essa é a sua área :)</h1>
            </div>
            <div class="direitamenuesta">
                ...
                <div class="infousermenuesta" style="margin-right: 65px;">
                    ...
                    <h1>Name user</h1>
                    <a href="${pageContext.request.contextPath}/CriaTelaAlteraDadosEsta"><p>Alterar Dados</p></a>
                </div>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/RespondePagEsta">
                            <button name="btn" value="notificaEsta">
                                ...
                                <input type="hidden" name="lineUser" value="${mes.nome}">
                            ...
                            <button>
                                ...
                                <path d="M6.09 1.89H5.88C5.9955 1.89 6.09 1.7955 6.09 1.68V1.89H14.07V1.68C14.07 1.7955 14.1645 1.89 14.28 1.89H14.07V3.78H15.96V1.68C15.96 0.753375 15.2066 0 14.28 0H5.88C4.95337 0 4.2 0.753375 4.2 1.68V3.78H6.09V1.89ZM19.32 3.78H0.84C0.375375 3.78 0 4.15538 0 4.62V5.46C0 5.5755 0.0945 5.67 0.21 5.67H1.7955L2.44388 19.3988C2.48588 20.2939 3.22613 21 4.12125 21H16.0387C16.9365 21 17.6741 20.2965 17.7161 19.3988L18.3645 5.67H19.95C20.0655 5.67 20.16 5.5755 20.16 5.46V4.62C20.16 4.15538 19.7846 3.78 19.32 3.78ZM15.8366 19.11H4.32338L3.68812 5.67H16.4719L15.8366 19.11Z" fill="#EE4381"/>
                                </svg>                            
                            </button>
                        </form>
                    </td>

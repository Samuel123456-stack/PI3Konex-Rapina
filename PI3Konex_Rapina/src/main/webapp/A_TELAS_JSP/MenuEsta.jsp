...
<html>
    <head>
        <meta charset="UTF-8">    <title>Menu Estabelecimento</title>
            ...
            <section class="menu-baresta">
                ...
                <div class="direitamenuesta">
                    <form action="${pageContext.request.contextPath}/SubMenusEsta">
                        ...
                        <button name="btn" value="telaNotificacao">
                        ...
                        <div class="infousermenuesta">
                            <img src="${pageContext.request.contextPath}/images/Squircle.png" alt="">
                        ...
                        <button name="btn" value="alteraPlano">
                    ...
                    <tbody>
                        <c:forEach var="listaRes" items="${sessionScope.dadosListaRes}">
                            <tr>
                                ...
                                <c:if test="${listaRes.reserva_status=='Validada'}">
                                    <td><div class="validada">1</div></td>
                                </c:if>
                                <c:if test="${listaRes.reserva_status=='Aplicada'}">
                                    <td><div class="aplicada">1</div></td>
                                </c:if>
                            </tr>
                        </c:forEach>
                    </tbody>
                        ...
                        <c:forEach var="res" items="${consRes}">
                            <tr>
                                <c:if test="${res.reserva_status=='Cancelada'}">
                                    ...
                                    <c:if test="${listaRes.reserva_status=='Validada'}">
                                    <td><div class="validada2"></div><c:out value="${res.reserva_status}"/></td>
                                    </c:if>
                                    <c:if test="${listaRes.reserva_status=='Aplicada'}">
                                    <td><div class="aplicada2"></div><c:out value="${res.reserva_status}"/></td>
                                    </c:if>

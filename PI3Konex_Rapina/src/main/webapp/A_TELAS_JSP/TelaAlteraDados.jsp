    ...
    <div class="todo">
        <div class="bloco">
            ...
            <form action="${pageContext.request.contextPath}/AtualizaDados">
                ...
                <!--NOME-->
                <input class="topotext" type="text" id="nome" name="nome" placeholder="Digite seu nome">
                ...
                <!--DATA NASCIMENTO-->
                <input class="data" type="text" id="data" name="dataNasc" placeholder="Qual é a sua data de nascimento?">
                <div class="svgdata">
                ...
                <!--NOVA SENHA-->
                <input class="text" type="password" id="newsenha" name="newsenha" placeholder="Digite a nova senha">

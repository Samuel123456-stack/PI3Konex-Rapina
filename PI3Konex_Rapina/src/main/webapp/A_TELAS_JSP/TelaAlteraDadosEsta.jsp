...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel='stylesheet' type='text/css' href="${pageContext.request.contextPath}/CSS/altEsta.css">
        <title>Alterando dados da Loja</title>
    </head>
    <body>
        <div class="todo">
            ...
            <div class="bloco">
                ...
                <form action="${pageContext.request.contextPath}/AtualizaDadosEsta" method="get">
                    ...
                    <div class="sombra270">
                        ...
                        <input class="text270" type="text" id="num" name="numero" placeholder="Número" value="${esta.numero}">
                    </div>
                    ...
                    <div class="acessi">
                        ...
                        <div class="radio">
                            ...
                            <div class="marginRadio"></div>
                            <label for="Nãotenho">
                                <input type="checkbox" id="Nãotenho" name="acessi" value="Nãotenho" value="${esta.acessi_nenhuma}">
                                <p>Não tenho</p>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="sombra373">                       
                        <input class="horario" type="text" id="horario" name="horariofun" placeholder="Horário de funcionamento" value="${esta.horario_funcionamento}">
                        <div class="svghora">
                    ...
                    <div class="sombra373">
                        ...
                        <input class="text373" type="text" id="capmes" name="capacidade" placeholder="Qual é a capacidade de mesas?" value="${esta.capacidade}">
                    </div>
